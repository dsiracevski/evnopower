    ...
    <div class="mx-auto md:w-1/2 w-full">
        ...
        <form action="{{route('notification.set-locations')}}" method="POST">
            ...
            <div class="py-3 px-4 my-4 shadow-xl rounded-lg border-2 border-blue-50 md:space-y-0 space-y-2">
                ...
                <input id="email" type="email" value="" name="email" class="px-2 border-2 border-blue-300 rounded-lg"
                       required>
                ...
                <div class="py-2 px-4">
                    ...
                    @foreach($locations as $location)
                        ...
                        <div class="inline-flex mx-1 my-1">
                            ...
                            <div class="py-2 px-5 rounded-full text-sm text-white bg-blue-500 w-max cursor-pointer">

                                <label class="cursor-pointer" for="{{$location->id}}">{{$location->name}}</label>
                                <input class="cursor-pointer"
                                       @if(in_array($location->id, $userLocations, true)) checked @else '' @endif
